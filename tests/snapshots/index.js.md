...
> stdout
    ...
    `owner and repositories set, creating token for repositories "create-github-app-token-aws" owned by "lepadatu-actions"␊
...
> stdout
    ...
    `owner and repositories set, creating token for repositories "failed-repo" owned by "lepadatu-actions"␊
...
> stdout
    ...
    `owner and repositories set, creating token for repositories "create-github-app-token-aws,toolkit" owned by "lepadatu-actions"␊
    ::add-mask::ghs_16C7e42F292c6912E7710c838347Ae178B4a␊
    ␊
    ::set-output name=token::ghs_16C7e42F292c6912E7710c838347Ae178B4a␊
    ␊
...
> stdout
    ...
    `owner not set, creating owner for given repositories "create-github-app-token-aws" in current owner ("lepadatu-actions")␊
    ::add-mask::ghs_16C7e42F292c6912E7710c838347Ae178B4a␊
    ␊
    ::set-output name=token::ghs_16C7e42F292c6912E7710c838347Ae178B4a␊
    ␊
